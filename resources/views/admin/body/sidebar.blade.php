        ...
        <div class="navbar-content scroll-div ">
            ...
            <div class="">
                <div class="main-menu-header">
                    <img class="img-radius" src=" {{asset('Admin/assets/images/user/avatar-1.jpg')}}" alt="User-Profile-Image">
                    <div class="user-details">
                        <span>{{Auth::user()->name}}</span>
                        <div id="more-details">Web Developer<i class="fa fa-chevron-down m-l-5"></i></div>
                    </div>
                </div>
                <div class="collapse" id="nav-user-link">
                    <ul class="list-unstyled">
                        <li class="list-group-item"><a href="{{route('admin.index')}}"><i class="feather icon-user m-r-5"></i>View Profile</a></li>
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="{{route('list')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-grid"></i></span><span class="pcoded-mtext">Category</span></a>
                </li>
                <li class="nav-item">
                    <a href="{{route('subcategory.list')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-inbox"></i></span><span class="pcoded-mtext">SubCategory</span></a>
                </li>
                <li class="nav-item">
                    <a href="{{route('post.list')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-plus-square"></i></span><span class="pcoded-mtext">Post</span></a>
                </li>
