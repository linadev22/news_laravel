                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal-{{$item->id}}">
                                                    ...
                                                    <form method="post" action="{{ route('subcategory.update',$item->id) }}">
                                                        ...
                                                        <div class="mb-3">
                                                            <select name="category_id" class="form-control" aria-label="Default select example">
                                                                ...
                                                                @foreach ($main_subcategories as $itemz)
                                                                <option value="{{$itemz->id}}" {{$item->category_id==$itemz->id?"selected":""}}>{{$itemz->name_kh}}|{{$itemz->name_en}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="namekh" class="form-label">Category Kh</label>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="nameen" class="form-label">Category En</label>
                                    ...
                                    <a href="{{ route('subcategory.delete',$item->id) }}" class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="card-body">
                <form method="post" action="{{route('subcategory.store')}}">
                    ...
                    <div class="mb-3">
                        <select name="category_id" class="form-control" aria-label="Default select example">
                            <option selected>--Select Category--</option>
                            @foreach ($main_subcategories as $item)
                            <option value="{{$item->id}}">{{$item->name_kh}}|{{$item->name_en}}</option>
                            @endforeach
                    ...
                    <div class="mb-3">
                        <label for="namekh" class="form-label">SubCategory Khmer</label>
                    ...
                    <div class="mb-3">
                        <label for="nameen" class="form-label">SubCategory English</label>
